...
<div class="nets">
	...
	<button
		...
		onclick={() => go('snapchat')}
	>
		<svg viewBox="0 0 24 24" fill="currentColor" stroke="#16161d" stroke-width="0.9" stroke-linejoin="round">
			<path
...
<style>
	...
	.net.snapchat {
		background: #fffc00;
		/* The official ghost: white fill, black outline. */
		color: #fff;
	}
	...
	@media (max-width: 480px) {
		...
		/* These two glyphs draw well inside their viewBox and read small
		   at phone size; give them more of the disc. */
		.net.instagram svg,
		.net.facebook svg {
			width: 28px;
			height: 28px;
